...
class CompanySeeder extends Seeder
{
    ...
    public function run()
    {
        Company::factory()->create([
            ...
            'page_footer' => '<hr style="margin:5px;" /><p style="font-size:12px; text-align: justify;">Società soggetta a direzione e coordinamento della Mediterranea Marittima S.p.A. <b>Sede Legale e Uffici:</b> Via Alcide De Gasperi, 55 - 80133 Napoli Tel. 081.5801223 - Fax 081.5512770 - Capitale Sociale € 6\'000\'000.00 int. vers. Codice Fiscale, Partita IVA e numero iscrizione Registro delle Imprese di Napoli 05984260637 R.E.A. 473782 - <b>Call Center:</b> Tel. 081.3334411 - info@medmarnavi.it - www.medmarnavi.it</p>',
            'page_warehouse_terms' => '<span style="font-size:8px; text-align: justify;">
